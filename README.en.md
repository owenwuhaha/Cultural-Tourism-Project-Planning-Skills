...
[![Version](https://img.shields.io/badge/version-2.4.0-blue)](./SKILL.md)
...
| 📊 **Competitive Analysis Tool** [`competitive-analysis.py`](./scripts/competitive-analysis.py) | 2-5 competitors, 6D radar chart + matrix + SWOT + differentiation advice, dark-themed HTML report |
...
This repository includes 7 ready-to-run Python scripts:

| Script | Version | Description | Usage |
|--------|---------|-------------|-------|
| [`scripts/project-dashboard.py`](./scripts/project-dashboard.py) | V2.4 🆕 | **Project Dashboard** — Auto-scan projects/ and aggregate reports into unified dashboard | `python project-dashboard.py` |
| [`scripts/competitive-analysis.py`](./scripts/competitive-analysis.py) | V2.3 | **Competitive Analysis** — 6D radar + matrix + SWOT, dark-themed HTML report | `python competitive-analysis.py` |
...
├── SKILL.md                       # Skill definition (14 modules V2.4)
...
└── scripts/                       # Executable tool scripts
    ├── project-dashboard.py         # Project dashboard (V2.4 New)
...
| V2.5 | Map API integration, enhanced real-map heatmap | 🔜 Planned |
| V2.6 | Dynamic knowledge base queries (wenlv-wiki on demand) | 🔜 Planned |
