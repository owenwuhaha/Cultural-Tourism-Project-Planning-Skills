...
This repository includes 6 ready-to-run Python scripts:
...
├── SKILL.md                       # Skill definition (14 modules V2.3)
...
└── scripts/                       # Executable tool scripts
    ├── competitive-analysis.py      # Competitive analysis (V2.3 New)
...
| V2.4 | Map API integration, enhanced real-map heatmap | 🔜 Planned |
| V2.5 | Dynamic knowledge base queries (wenlv-wiki on demand) | 🔜 Planned |
