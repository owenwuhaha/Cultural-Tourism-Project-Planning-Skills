...
This repository includes 8 ready-to-run Python scripts:

| Script | Version | Description | Usage |
|--------|---------|-------------|-------|
| [`scripts/knowledge-query.py`](./scripts/knowledge-query.py) | V2.5 🆕 | **Knowledge Base Query** — Interactive browse of wenlv-wiki KB, keyword search, dimension/type filtering, export to HTML | `python knowledge-query.py` |
